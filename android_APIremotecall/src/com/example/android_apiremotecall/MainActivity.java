package com.example.android_apiremotecall;
...
public class MainActivity extends Activity {
    ...
    private static String getSex = "getSex";
    private static String jsonResult = "success";
    String uname;
    String age_res, age_sex;
    TextView Results, ResultsSex;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
     ...
     ResultsSex = (TextView) findViewById(R.id.ResultsSex);
     Button GetSex = (Button) findViewById(R.id.GetSex);
     //Get Age Button
            ...
            try {
                if (json.getString(jsonResult) != null) {
                    ...
                    if(Integer.parseInt(res) == 1){
                        ...
                        JSONObject json_user = json.getJSONObject("user");
                        //Set the results text to the age from the above JSON object
                        ResultsSex.setText("User Sex: " + json_user.getString("sex"));
                    }else{
                        //If the user could not be found
                        ResultsSex.setText("User could not be found");
                    }
                }
            } catch (JSONException e) {
                e.printStackTrace();
    ...
    public JSONObject getSex(String name){
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("tag", getSex));
        params.add(new BasicNameValuePair("name", name));
        JSONObject json = jsonParser.getJSONFromUrl(ageURL, params);
        return json;
    }
